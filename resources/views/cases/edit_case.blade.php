...
@section("contents")
 ...
 <!-- <div class="row">-->
                     ...
                     <div class="form-group">
                      ...
                      <input type="file" class="form-control" name="order" id="order" />
                       @if ($errors->has('order'))
 ...
 <button type="button" class="btn btn-success pull-right" id="hearing_button" >Update</button>
</div>
</div>
...
<!-------------------------------------------->
						 ...
						 <button class="btn btn-danger noEditable" onClick="window.location.reload();">Cancel</button>		
                      <input type="submit" class="btn btn-success noEditable" value="Update Case">
...
$("#hearing_button").click(function(){
  //alert("Hello");
  var id="{{$editCase->id}}";
  //alert(id);
  var url="{{url('hearing/'.$editCase->id)}}";
  //alert(url);
  //return false;
  var token = $("input[name='_token']").val();
  var date_of_hearing=$("input[name='date_of_hearing']").val();
  var update_notes=$("textarea[name='update_notes']").val();
  var next_date=$("input[name='next_date']").val();
...
url:url,
method:'POST',
//data:{_token:token,date_of_hearing:date_of_hearing,update_notes:update_notes,next_date:next_date,order:order},
data:{_token:token,date_of_hearing:date_of_hearing,update_notes:update_notes,next_date:next_date,order:filename},
//cache: false,
...
success:function(dataResult){
 ...
 var dataResult = JSON.parse(dataResult);
  if(dataResult.statusCode==200){
                    window.location = "{{url('/showAllCases')}}";        
 }
