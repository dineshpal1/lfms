  <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
				 ...
				 <li><a href="{{url('home')}}"><i class="fa fa-dashboard"></i> Dashboard <!--<span class="fa fa-chevron-down"></span>--></a>
                  <!--
              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <!-- <li><a><i class="fa fa-sitemap"></i> Reports  <span class="fa fa-chevron-down"></span></a>
				   ...
				   <li class="report"><a><i class="fa fa-bar-chart" aria-hidden="true"></i> Reports  <span class="fa fa-chevron-down"></span></a>
					<ul class="all nav child_menu">
				   <li class="invoice" ><a> Invoices <!-- <span class="fa fa-chevron-down"></span>--></a>
                   </li>
				 
				   </ul>
                   </li>
					
					{{--<li class="archive" ><a><i class="fa fa-file-archive-o" aria-hidden="true"></i>Archive <span class="fa fa-chevron-down"></span></a>
                      <ul>
                         <li class="all><a href="{{url('archiveCase')}}">Case Archive</a></li>
                        <li class="all><a href="{{url('archiveClient')}}">Client Archive</a></li>
                        <li class="all><a href="{{url('archiveEmployee')}}">Employee Archive</a></li>
                      </ul>
                     </li>--}}
