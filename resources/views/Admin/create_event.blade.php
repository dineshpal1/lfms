...
var associates_list2= $("#associates_id").val();

  $.each(associates_list2.split(","), function(i,e){
...
//alert(date.format('LT'));
//alert(date.add(1, 'hours').format('LT'));
...
//+ event.customer + '<br/>'
      //  + '<strong id="clients_id_hidden">Clients: </strong><br/>' + event.clients + '<br/>'
       //  + 
         '<strong id="clients_id_hiddens' + event.id + '" style="display:none;">' + event.clients + '</strong>'
       // + '<strong id="associates_id_hidden">Associates: </strong><br/>' + event.associates + '<br/>'
         + '<strong id="associates_id_hiddens' + event.id + '" style="display:none;">' + event.associates + '</strong>'
          + '<strong id="event_id_hiddens' + event.id + '" style="display:none;">' + event.id + '</strong>'
           + '<input type="hidden" id="events_hidden" value="' + event.id + '" name="events_hidden">'
    ...
    element.append(new_description);
              ...
              /*  element.find('.fc-title').append("<br/>" + '<input type="hidden" id="events_hidden2" class="events_hidden23" value="' + event.id + '" name="events_hidden2">'); */

},
        eventClick: function (calEvent, jsEvent, view) {
            $('#fc_edit').click();
           // alert(calEvent.starts);
        ...
        $('#start_time2').val(starttime); 
         ...
         if(today>calEvent.starts)
         {
           ...
           $('.antosubmit2').hide();
            ...
            var client_list2= $("#clients_id").val();

$.each(client_list2.split(","), function(i,e){
