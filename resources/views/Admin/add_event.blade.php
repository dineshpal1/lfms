...
<link rel="stylesheet" href="{{asset('dist/css/bootstrap.min.css')}}">
  ...
  <script src="{{asset('dist/js/jquery.touchSwipe.min.js')}}"></script>
  <script src="{{asset('dist/js/jquery-calendar.min.js')}}"></script>
  <link rel="stylesheet" href="{{asset('dist/css/jquery-calendar.min.css')}}">
 ...
 <script>
    $(document).ready(function(){
      ...
      var events = [
        {
          start: now.startOf('week').add(8, 'h').format('X'),
          end: now.startOf('week').add(10, 'h').format('X'),
          title: '1',
          content: 'Hello World! From 8 AM <br> <p>Foo Bar</p>',
