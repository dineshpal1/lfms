...
<!--               <option value="">Choose Client</option>
 -->             <?php foreach($allclient as $client){?>
          ...
          <div class="modal-footer">
            ...
            <button type="button" class="btn btn-primary antosubmit2" data-dismiss="modal">Save changes</button>
          </div>
        </div>
      </div>
    </div>
...
function init_calendar() {
    ...
    var calendar = $('#calendar').fullCalendar({
       ...
       eventColor: '#039be5',
       eventTextColor:'#FFF',
      /* events:[{"title":"All Day Event","start":"2020-04-01 00:00:00"},
      ...
      /* events:[{"title":"All Day Event","start":"2020-04-01 00:00:00"},
       ...
       {"title":"Repeating Event","start":"2020-04-09 16:00:00"},
       {"title":"Conference","start":"2020-04-11 00:00:00"},
       {"title":"Meeting","start":"2020-04-12 10:30:00"},
       {"title":"Lunch","start":"2020-04-12 12:00:00"},
       {"title":"Happy Hour","start":"2020-04-12 17:30:00"},
       {"title":"Dinner","start":"2020-04-12 20:00:00"},
       {"title":"Birthday Party","start":"2020-04-14 07:00:00"},
       {"title":"Double click to change","start":"2020-04-28 00:00:00"},
       {"title":"AAAAAAAAA","start":"2020-04-27 00:00:00"},
       {"title":"BBBBBB","start":"2020-04-27 00:00:00"},
       {"title":"Delhi Lockdown","start":"2020-04-02 00:00:00"},
       {"title":"Event24","start":"2020-04-04 00:00:00"}]
       */
        /*events:[{
            title: 'All Day Event',
...
var formData=$('#antoform').serialize();
      ...
      $.ajax({
          ...
          data: {title:title,start_date:start_date,start_time:start_time,end_date:end_date,end_time:end_time,client:client,descr:descr,event_type:event_type, _token:token},
...
var formData=$('#antoform').serialize();
      ...
      $.ajax({
          ...
          method: 'POST',
          //data: {formData:formData, _token:token},
          data: {event_id:event_id,title:title2,start_date:start_date2,start_time:start_time2,end_date:end_date2,end_time:end_time2,client:client2,descr:descr2,event_type:event_type2, _token:token},
          success: function(data) {
