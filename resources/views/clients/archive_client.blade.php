            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title">ALL ARCHIVE CLIENT LIST  </h4>
                ...
                <?php }?>
                  ...
                  <a href="{{url('showClient',$client->id)}}"><img  src="{{asset('uploads/client_photo/'.$client->profile_photo)}}"  style="height: 50px; width: 50px" alt=""> <?php }else {?>
                     <h5>No Image</h5>
                      <?php } ?></a>
                ...
                <td><a class="btn btn-success btn-sm" href="{{url('restoreClient',$client->id)}}"><i class='fas fa-trash-restore-alt'></i></a></td>
