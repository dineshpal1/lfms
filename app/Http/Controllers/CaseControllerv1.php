...
$dates->previous_date  =$updateCase->hearing_date;
$dates->current_notes  =$request->notes;
$dates->next_date      =$request->hearing_date;; 
$dates->prv_notes =$updateCase->notes;
$dates->save();
...
$updateCase->emp_id       =$emp->id; 
        ...
        $updateCase->hearing_date =$request->hearing_date;
...
return redirect("showAllCases")->with("successMsg","CASE UPDATED SUCCESSFULLY");
    ...
    public function showCase($id)
    {
	  ...
	  $activity_on_hearing_dates=DB::table("cases")
							->select('cases.casetitle','cases.judgename','hearing_dates.previous_date','hearing_dates.prv_notes','hearing_dates.next_date','hearing_dates.current_notes')
	...
	public function saveCaseDetails(Request $request)
{
 ...
 //echo $params['casetitle'];
        ...
        $case->hearing_date      = isset($params['hearing_date']) ? $params['hearing_date'] : ' ';
