...
$extension_doc=$judgement->extension();
// echo $extension;
//exit;
...
$dates->extension_doc =isset($extension_doc)?$extension_doc:"";
...
$updateCase->extension    =isset($extension)?$extension:" ";
$updateCase->save();
 ...
 public function saveMoreUploaded(Request $request,$id)
 {
  ...
  // exit;case
    ...
    $this->validate($request,[
      ...
      'multiple_document.*'=>'mimes:jpeg,jpg,pdf|max:50000'
